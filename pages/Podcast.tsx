            ...
            <div className="container mx-auto px-6">
                ...
                <div className="max-w-4xl mx-auto bg-slate-50 rounded-2xl p-12 text-center border border-slate-100">
                    ...
                    <div className="flex flex-wrap gap-4 items-center justify-center">
                        ...
                        <a href="#" className="flex items-center gap-2 bg-black text-white px-6 py-3 rounded-full font-bold hover:bg-slate-900 transition-colors min-w-[200px] justify-center">
