            ...
            <footer className="py-12 bg-slate-50 border-t border-slate-200">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto text-xs text-slate-400 space-y-4 text-center leading-relaxed">
                        ...
                        <p>
                            BuildSurge Collectives LLC DBA BuilderProject is a specialized marketing agency and consultancy for the construction industry. We do not sell a business opportunity, "get rich quick" program or money-making system. We believe, with specialized guidance, individuals can be better prepared to make business strategic decisions, but we do not guarantee success in our services or training. We do not make earnings claims, efforts claims, or claims that our services will make you any money. All material is intellectual property and protected by copyright. Any duplication, reproduction, or distribution is strictly prohibited. Please see our Full Disclosure for important details.
                        </p>
                        <p>
                            Business and marketing initiatives carry inherent risk and it is possible to lose some or all of your investment. The guidance provided is general in nature, and some strategies may not be appropriate for all individuals or all situations. We make no representation regarding the likelihood or probability that any actual or hypothetical marketing campaign or strategy will achieve a particular outcome or perform in any predictable manner.
                        </p>
                        <p>
                            Statements and depictions are the opinions, findings, or experiences of individuals who generally have purchased our services or training. Results vary, are not typical, and rely on individual effort, time, and skill, as well as unknown conditions and other factors. We do not measure earnings or financial performance. Instead, we track completed transactions and satisfaction of services by voluntary surveys. You should not, however, equate reported sales transactions with financially successful transactions. Further, many customers do not continue with the program, do not apply what they learn, or do attempt to apply what they learn but nonetheless have difficulty in making sales successful for them.
                        </p>
                        <p>
