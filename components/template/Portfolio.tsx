...
const Portfolio = ({ showViewAll = true }: { showViewAll?: boolean }) => {
    return (
        <section className="py-0 relative">
            ...
            {showViewAll && (
                <div className="bg-slate-900 py-24 text-center">
                    <button
                        className="inline-block px-12 py-5 border-2 border-white/20 text-white font-bold tracking-widest uppercase hover:bg-white hover:text-slate-900 hover:border-white transition-all duration-300"
                    >
                        View Full Portfolio
                    </button>
                </div>
