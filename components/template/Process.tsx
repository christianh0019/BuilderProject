        ...
        <section className="py-32 bg-slate-50">
            <div className="container mx-auto px-6">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-5xl font-serif font-bold text-slate-900 mt-4 mb-6">A Seamless Path to Your Dream Home</h2>
                    ...
                    <button className="inline-flex items-center px-8 py-4 bg-[#2B70B6] text-white font-bold uppercase tracking-widest hover:bg-white hover:text-[#2B70B6] transition-colors rounded-full shadow-lg">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
                        {steps.map((step, index) => (
                            ...
                            >
                                ...
                                <h4 className="text-xl font-serif font-bold text-slate-900 mb-4">{index + 1}. {step.title}</h4>
